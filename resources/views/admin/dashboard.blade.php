    ...
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Pelanggan
                                </h6>
                            </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div>
                                <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">
                                    Rp. 18,306</h2>
                                <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Hasil Penjualan
                                </h6>
                            </div>
                            <div class="ms-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Menu
                                </h6>
                            </div>
                            <div class="ms-auto mt-md-3 mt-lg-0">
        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list-inline text-center mt-5 mb-2">
                            <li class="list-inline-item text-muted fst-italic">Penjualan Per Bulan</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Penghasilan Berdasarkan Lokasi</h4>
