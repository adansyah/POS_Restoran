...
<body class="tw-flex tw-min-h-[100vh] tw-w-full tw-flex-col tw-text-white tw-bg-[#000]">
    ...
    <section
        ...
        <div class="tw-flex max-lg:tw-flex-col tw-gap-2 tw-p-2 tw-w-full tw-h-full">
            ...
            <div class="tw-flex tw-place-content-center tw-place-items-center tw-w-full lg:tw-max-w-[50vw]"
                data-aos="fade-left" data-aos-duration="700" data-aos-anchor="#example-anchor" data-aos-offset="500">
                <div class="tw-max-w-[560px] tw-w-full">
    ...
    <section
        ...
        <div class="tw-flex tw-h-full tw-flex-col tw-gap-[5%] max-md:tw-mt-2 max-md:tw-gap-[3%] max-md:tw-text-center"
            ...
            <h2 class="tw-text-4xl tw-font-medium max-md:tw-text-2xl">
    ...
    <section
        ...
        <h3 class="primary-text-color tw-text-4xl tw-font-semibold" data-aos="fade-zoom-in"
        ...
        <div class="tw-mt-[5%] tw-flex tw-w-full tw-place-content-center tw-gap-5 max-md:tw-flex-wrap">
            <div class="tw-flex tw-max-w-[650px] tw-flex-col tw-gap-8 ">
                <div class="tw-flex tw-gap-10 max-md:tw-flex-col max-md:tw-place-items-center"
                ...
                <div class="tw-flex tw-gap-10 max-md:tw-flex-col max-md:tw-place-items-center" data-aos="fade-up-left"
                    data-aos-duration="700">
                    <div class="tw-w-[180px] tw-h-[180px] tw-overflow-hidden tw-rounded-md">
    ...
    <section
        ...
        <h3 class="primary-text-color tw-text-4xl tw-font-semibold" data-aos="flip-up" data-aos-duration="700">
            Explore our menu
        </h3>
            ...
            <div class="tw-flex tw-max-w-[650px] tw-flex-col tw-gap-5 tw-overflow-clip md:tw-max-h-[700px]">
                <div class="tw-flex tw-gap-5 max-md:tw-flex-col">
                    <div data-aos="fade-right" data-aos-duration="700"
                        ...
                        <img src="{{ asset('assets/images/homepage/coffee.jpg') }}" alt="authentic wine"
                            class="tw-h-full tw-w-full tw-object-cover tw-transition-[scale] tw-duration-[0.4s]" />
        ...
        <div class="tw-mt-[5%] tw-flex tw-h-full tw-flex-col tw-gap-[5%]">
            ...
            <form class="tw-mt-4 tw-flex tw-max-w-[350px] tw-flex-col tw-gap-3">
                <div class="tw-flex tw-flex-col tw-gap-4">
                    <div class="tw-flex tw-flex-col tw-gap-1" data-aos="fade-left" data-aos-duration="300">
                        <div class="tw-text-gray-300">Name</div>
                        <input type="text" class="input" maxlength="10" required placeholder="name" />
                    </div>
                    <div class="tw-flex tw-flex-col tw-gap-1" data-aos="fade-left" data-aos-duration="400">
                ...
                <div class="tw-flex tw-gap-4">
                    <div class="tw-flex tw-w-full tw-flex-col tw-gap-1" data-aos="fade-left" data-aos-duration="600">
                ...
                <button type="submit"
                    class="btn tw-ml-auto tw-mr-auto tw-mx-auto tw-mt-5 tw-transition-transform tw-duration-[0.3s] hover:tw-translate-x-2">
